...
// Source: github.com/nilesh0729/Notes/internal/db/Result (interfaces: Store)
...
func (m *MockStore) GetNotesForTag(arg0 context.Context, arg1 Database.GetNotesForTagParams) ([]Database.GetNotesForTagRow, error) {
	m.ctrl.T.Helper()
